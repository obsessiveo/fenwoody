export const SVGBOARD = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:x="http://www.w3.org/1999/xlink" viewBox="0 0 360 360"
...
<defs>
    ...
    <g id="kd"
        ...
        <path d="M 22.5,11.63 L 22.5,6"
            style="fill:none; stroke:#000000; stroke-linejoin:miter;" id="path6570" />
        <path
    ...
    <!-- King light -->
    <g id="kl" fill="none" fill-rule="evenodd" stroke="#000" stroke-linecap="round"
    ...
    <!-- Queen light -->
    <g id="ql" style="fill:#ffffff;stroke:#000000;stroke-width:1.5;stroke-linejoin:round">
        <path
            d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z" />
        <path
    ...
    <g id="coordinates-normal">
        <!-- files a,c, .., h -->
        <text x="0" y="360" dy="-2" dx="34" font-size="14" font-weight="bold"
            fill="url(#light)">a</text>
        <text x="45" y="360" dy="-2" dx="34" font-size="14" font-weight="bold"
            fill="url(#dark)">b</text>
        <text x="90" y="360" dy="-2" dx="34" font-size="14" font-weight="bold"
            fill="url(#light)">c</text>
        <text x="135" y="360" dy="-2" dx="34" font-size="14" font-weight="bold"
            fill="url(#dark)">d</text>
        <text x="180" y="360" dy="-2" dx="34" font-size="14" font-weight="bold"
            fill="url(#light)">e</text>
        <text x="225" y="360" dy="-2" dx="34" font-size="14" font-weight="bold"
            fill="url(#dark)">f</text>
        <text x="270" y="360" dy="-2" dx="34" font-size="14" font-weight="bold"
            fill="url(#light)">g</text>
        <text x="315" y="360" dy="-2" dx="34" font-size="14" font-weight="bold"
            fill="url(#dark)">h</text>
        <!-- Ranks 1,2, .., 8 -->
        <text x="0" y="315" dy="13" dx="0" font-size="14" font-weight="bold"
            fill="url(#light)">1</text>
        <text x="0" y="270" dy="13" dx="0" font-size="14" font-weight="bold"
            fill="url(#dark)">2</text>
        <text x="0" y="225" dy="13" dx="0" font-size="14" font-weight="bold"
            fill="url(#light)">3</text>
        <text x="0" y="180" dy="13" dx="0" font-size="14" font-weight="bold"
            fill="url(#dark)">4</text>
        <text x="0" y="135" dy="13" dx="0" font-size="14" font-weight="bold"
            fill="url(#light)">5</text>
        <text x="0" y="90" dy="13" dx="0" font-size="14" font-weight="bold"
            fill="url(#dark)">6</text>
        <text x="0" y="45" dy="13" dx="0" font-size="14" font-weight="bold"
            fill="url(#light)">7</text>
        <text x="0" y="0" dy="13" dx="0" font-size="14" font-weight="bold"
